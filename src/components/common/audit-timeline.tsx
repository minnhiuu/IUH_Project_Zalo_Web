...
const actionIcons: Record<AuditAction, React.ReactNode> = {
  ...
  [AuditAction.USER_BLOCKED]: <Shield className="size-4" />,
  [AuditAction.USER_UNBLOCKED]: <Shield className="size-4" />,
  [AuditAction.BLOCK_PREFERENCE_UPDATED]: <Shield className="size-4" />,
...
const actionColors: Record<AuditAction, string> = {
  ...
  [AuditAction.USER_BLOCKED]: 'text-red-600 bg-red-50 border-red-200',
  [AuditAction.USER_UNBLOCKED]: 'text-green-600 bg-green-50 border-green-200',
  [AuditAction.BLOCK_PREFERENCE_UPDATED]: 'text-orange-600 bg-orange-50 border-orange-200',
