  ...
  return (
    <div className='p-8 space-y-4'>
      ...
      <div className='space-y-2'>
        <p className='text-muted-foreground'>Click the button below to open user detail modal</p>

        <Button onClick={() => handleOpenUserDetail('user-id-here')}>View User Details</Button>
      </div>
...
/>`}
      ...
      <UserDetailModal userId={selectedUserId} open={open} onOpenChange={setOpen} />
    </div>
  )
}
