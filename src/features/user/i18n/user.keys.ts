  ...
  settings: {
    ...
    interests: {
      ...
      tags: {
        ...
        photography: 'user.settings.interests.tags.photography',
        fitness: 'user.settings.interests.tags.fitness',
        cooking: 'user.settings.interests.tags.cooking',
        coffee: 'user.settings.interests.tags.coffee',
        technology: 'user.settings.interests.tags.technology',
        artificialIntelligence: 'user.settings.interests.tags.artificialIntelligence',
        ...
        reading: 'user.settings.interests.tags.reading',
        art: 'user.settings.interests.tags.art',
        hiking: 'user.settings.interests.tags.hiking',
        yoga: 'user.settings.interests.tags.yoga',
        cycling: 'user.settings.interests.tags.cycling',
        football: 'user.settings.interests.tags.football',
        pets: 'user.settings.interests.tags.pets',
        streetFood: 'user.settings.interests.tags.streetFood',
        fashion: 'user.settings.interests.tags.fashion',
        mentalHealth: 'user.settings.interests.tags.mentalHealth',
        entrepreneurship: 'user.settings.interests.tags.entrepreneurship',
        sustainableLiving: 'user.settings.interests.tags.sustainableLiving',
        interiorDesign: 'user.settings.interests.tags.interiorDesign',
        basketball: 'user.settings.interests.tags.basketball',
        baking: 'user.settings.interests.tags.baking',
        webDevelopment: 'user.settings.interests.tags.webDevelopment',
        cybersecurity: 'user.settings.interests.tags.cybersecurity',
        mobileApps: 'user.settings.interests.tags.mobileApps',
        wineTasting: 'user.settings.interests.tags.wineTasting',
        veganism: 'user.settings.interests.tags.veganism'
      }
    }
  }
} as const
