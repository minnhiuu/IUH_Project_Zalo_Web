  ...
  settings: {
    ...
    interests: {
      ...
      tags: {
        ...
        photography: t(USER_KEYS.settings.interests.tags.photography),
        fitness: t(USER_KEYS.settings.interests.tags.fitness),
        cooking: t(USER_KEYS.settings.interests.tags.cooking),
        coffee: t(USER_KEYS.settings.interests.tags.coffee),
        technology: t(USER_KEYS.settings.interests.tags.technology),
        artificialIntelligence: t(USER_KEYS.settings.interests.tags.artificialIntelligence),
        ...
        reading: t(USER_KEYS.settings.interests.tags.reading),
        art: t(USER_KEYS.settings.interests.tags.art),
        hiking: t(USER_KEYS.settings.interests.tags.hiking),
        yoga: t(USER_KEYS.settings.interests.tags.yoga),
        cycling: t(USER_KEYS.settings.interests.tags.cycling),
        football: t(USER_KEYS.settings.interests.tags.football),
        pets: t(USER_KEYS.settings.interests.tags.pets),
        streetFood: t(USER_KEYS.settings.interests.tags.streetFood),
        fashion: t(USER_KEYS.settings.interests.tags.fashion),
        mentalHealth: t(USER_KEYS.settings.interests.tags.mentalHealth),
        entrepreneurship: t(USER_KEYS.settings.interests.tags.entrepreneurship),
        sustainableLiving: t(USER_KEYS.settings.interests.tags.sustainableLiving),
        interiorDesign: t(USER_KEYS.settings.interests.tags.interiorDesign),
        basketball: t(USER_KEYS.settings.interests.tags.basketball),
        baking: t(USER_KEYS.settings.interests.tags.baking),
        webDevelopment: t(USER_KEYS.settings.interests.tags.webDevelopment),
        cybersecurity: t(USER_KEYS.settings.interests.tags.cybersecurity),
        mobileApps: t(USER_KEYS.settings.interests.tags.mobileApps),
        wineTasting: t(USER_KEYS.settings.interests.tags.wineTasting),
        veganism: t(USER_KEYS.settings.interests.tags.veganism)
      }
    }
  }
})
