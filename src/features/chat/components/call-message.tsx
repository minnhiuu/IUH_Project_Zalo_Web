...
export function CallMessage({ message, isOwn, onRecall }: CallMessageProps) {
  ...
  switch (action) {
    case 'ended':
      statusText = isCaller
        ? t('call.you_called')
        : t('call.they_called', { name: meta.callerName })
          ...
          <div className={cn('shrink-0', iconColorClass)}>
            {isOutgoing ? (
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" className="inline-block">
                ...
                <path d="M16 3l4 4m0 0l-4 4m4-4H14" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            ) : (
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" className="inline-block">
                <path d="M6.62 10.79a15.053 15.053 0 006.59 6.59l2.2-2.2a1.003 1.003 0 011.01-.24c1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.1.31.03.66-.25 1.02l-2.2 2.2z" fill="currentColor"/>
                <path d="M22 3l-4 4m0 0l4 4m-4-4h6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            )}
          </div>
