...
export function resolveBlockMemberAction(context: ActionContext): ActionResolveResult {
  ...
  if (isTargetMe) {
    return { i18nKey: 'chat.system.block_member.self_blocked' }
  }

  if (isActorMe) {
    return {
      i18nKey: 'chat.system.block_member.by_you',
  ...
  return {
    i18nKey: 'chat.system.block_member.by_actor',
    values: {
