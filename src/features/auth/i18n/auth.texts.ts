...
export const createAuthTexts = (t: TFunction<'auth'>) => ({
  ...
  interests: {
    ...
    tags: {
      ...
      photography: t(AUTH_KEYS.interests.tags.photography),
      fitness: t(AUTH_KEYS.interests.tags.fitness),
      cooking: t(AUTH_KEYS.interests.tags.cooking),
      coffee: t(AUTH_KEYS.interests.tags.coffee),
      technology: t(AUTH_KEYS.interests.tags.technology),
      artificialIntelligence: t(AUTH_KEYS.interests.tags.artificialIntelligence),
      gaming: t(AUTH_KEYS.interests.tags.gaming),
      music: t(AUTH_KEYS.interests.tags.music),
      movies: t(AUTH_KEYS.interests.tags.movies),
      reading: t(AUTH_KEYS.interests.tags.reading),
      art: t(AUTH_KEYS.interests.tags.art),
      hiking: t(AUTH_KEYS.interests.tags.hiking),
      yoga: t(AUTH_KEYS.interests.tags.yoga),
      cycling: t(AUTH_KEYS.interests.tags.cycling),
      football: t(AUTH_KEYS.interests.tags.football),
      pets: t(AUTH_KEYS.interests.tags.pets),
      streetFood: t(AUTH_KEYS.interests.tags.streetFood),
      fashion: t(AUTH_KEYS.interests.tags.fashion),
      mentalHealth: t(AUTH_KEYS.interests.tags.mentalHealth),
      entrepreneurship: t(AUTH_KEYS.interests.tags.entrepreneurship),
      sustainableLiving: t(AUTH_KEYS.interests.tags.sustainableLiving),
      interiorDesign: t(AUTH_KEYS.interests.tags.interiorDesign),
      basketball: t(AUTH_KEYS.interests.tags.basketball),
      baking: t(AUTH_KEYS.interests.tags.baking),
      webDevelopment: t(AUTH_KEYS.interests.tags.webDevelopment),
      cybersecurity: t(AUTH_KEYS.interests.tags.cybersecurity),
      mobileApps: t(AUTH_KEYS.interests.tags.mobileApps),
      wineTasting: t(AUTH_KEYS.interests.tags.wineTasting),
      veganism: t(AUTH_KEYS.interests.tags.veganism)
    }
  },
